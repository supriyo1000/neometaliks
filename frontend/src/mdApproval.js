...
const MdApproval = () => {
    ...
    async function getCsrApproval() {
        const response = await fetch(`http://${ipAddress}:8000/interview/get_md_approval`).then(res => res.json());
            ...
            <div>
                ...
                <main id="main" class="main " style={{ marginTop: "80px" }}>
                    <div class="pagetitle">
                        ...
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">MD Approval</li>
                            </ol>
                        </nav>
                    </div>
                    <div className='card' style={{ padding: "20px" }}>
                        ...
                        {showcsrmdcomment && <CommentsModal alldetails={details} btnCode={btncode} approverCode={2} stid={studentId} />}
                    </div>
                </main>
            </div>
        </>
